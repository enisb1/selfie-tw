...
export async function getEventsInRange(startDate, endDate) {
    ...
    try {
        const response = await axios.get(`https://site232418.tw.cs.unibo.it/api/calendar/events?start=${startStringUTC}&end=${endStringUTC}`);
...
export async function getTodayEvents(userId) {
    ...
    try {
        const response = await axios.get(`https://site232418.tw.cs.unibo.it/api/calendar/events?start=${startStringUTC}&end=${endStringUTC}&userId=${userId}`);
        return response.data;
    } catch (error) {
        console.error("Error fetching events: ", error);
    }
...
export async function getTodayActivities(userId) {
    ...
    const endStringUTC = new Date((new Date()).setHours(23, 59, 59, 999)).toISOString();
    try {
        const response = await axios.get(`https://site232418.tw.cs.unibo.it/api/calendar/activities?start=${startStringUTC}&end=${endStringUTC}&userId=${userId}`);
        return response.data;
    } catch (error) {
        console.error("Error fetching events: ", error);
    }
...
export async function getEvents(userId) {
    try {
        const response = await axios.get(`https://site232418.tw.cs.unibo.it/api/calendar/events/${userId}`);
        return response.data;
    } catch (error) {
        console.error("Error fetching events: ", error);
    }
...
export async function getResourcesEvents() {
    try {
        const response = await axios.get(`https://site232418.tw.cs.unibo.it/api/calendar/resourcesEvents`);
        return response.data;
    } catch (error) {
        console.error("Error fetching events: ", error);
    }
...
export async function postEvent(title, location, start, end, frequency, repetitionNumber, repetitionDate, color, users, creator, resources,
    ...
    await axios.post('https://site232418.tw.cs.unibo.it/api/calendar/addEvent', {"title": title, "location": location, "startDate": start,
...
export async function postActivity(title, deadline, userIds, myId, compositeActivity, projectData) {
    await axios.post('https://site232418.tw.cs.unibo.it/api/calendar/addActivity', {"title": title, "deadline": deadline, 
...
export async function postSubacts(compositeActivityTitle, subactivities, users, myID) {
    ...
    await axios.post('https://site232418.tw.cs.unibo.it/api/calendar/sendCompositeInvite', {
        "groupId": groupId,
        "groupName": compositeActivityTitle,
        "users": users,
        "creator": myID
...
export async function updateActivityProjectId(activityId, projectId) {
    try {
        const response = await axios.put(`https://site232418.tw.cs.unibo.it/api/calendar/updateActivityProjectId/${activityId}`, { projectId });
        return response.data;
    } catch (error) {
...
export async function editActivity(activityId, updatedData) {
    await axios.put(`https://site232418.tw.cs.unibo.it/api/calendar/activities/${activityId}`, updatedData)
}
...
export async function editEvent(eventId, updatedData) {
    await axios.put(`https://site232418.tw.cs.unibo.it/api/calendar/events/${eventId}`, updatedData)
}

// get all resources
export async function getResources() {
    try {
        const response = await axios.get(`https://site232418.tw.cs.unibo.it/api/calendar/resources`);
        return response.data;
    } catch (error) {
        throw error.response.data;
    }
...
export async function getResourcesFromIds(resources) {
    try {
        const response = await axios.get(`https://site232418.tw.cs.unibo.it/api/calendar/resourcesFromIds?resources=${resources}`)
        return response.data;
    }catch (error) {
        throw error.response.data;
    }
...
export async function postResource(username) {
    await axios.post('https://site232418.tw.cs.unibo.it/api/calendar/addResource', {"username": username})
}

export async function removeResourceFromEvent(resourceId, eventId) {
    try {
        const response = await axios.patch(`https://site232418.tw.cs.unibo.it/api/calendar/removeResourceFromEvent`, {resource: resourceId, event: eventId})
        return response.data;
    }catch (error) {
        throw error.response.data;
    }
...
export async function deleteResource(resourceId) {
    await axios.delete(`https://site232418.tw.cs.unibo.it/api/calendar/resources/${resourceId}`)
}

export async function getEventsByResource(resourceId) {
    try {
        const response = await axios.get(`https://site232418.tw.cs.unibo.it/api/calendar/eventsByResource/${resourceId}`);
        return response.data;
    } catch (error) {
        throw error.response.data;
    }
...
export async function deleteActivitiesByGroup(groupName, groupId) {
    try {
        const response = await axios.delete('https://site232418.tw.cs.unibo.it/api/calendar/deleteByGroup', {
...
export async function sendExportMail(formData) {
    try {
        const response = await axios.post(`https://site232418.tw.cs.unibo.it/api/calendar/export`, formData);
        return response.data;
    } catch (error) {
