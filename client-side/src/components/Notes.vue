            ...
            <div class="content bg-white p-2">
                ...
                <form action="#">
                    ...
                    <div class="row title p-2  grid grid-row-2">
                        ...
                        <input class="border border-ylblue-500 caret-ylblue-500" type="text" id="note_category" required>
                    </div>

                    <div class="row access list p-2  grid grid-row-2">
                        <label class="font-semibold py-1" for="access list">Access List</label>
                        <select class="shadow-xl border border-ylblue-500" name="Access List" id="access_list" required>
                    ...
                    <div class="flex justify-center mx-12 p-4">
                        <button id="SaveButton" class="px-4 py-1 shadow-xl hover:bg-ylblue-500 hover:text-white font-semibold"">Save</buttom>
                    </div>
            ...
            <div class="content bg-white p-2">
                ...
                <form action="#">
                    <div class="grid grid-rows-2 grid-cols-2 p-2 cursor-pointer">
                        <bottom id="buttonDate" class="flex flex-col items-center p-2 m-2 bg-lavender-500 rounded-lg hover:bg-ylblue-500 hover:text-white">
                            <img id="buttonImage" class="w-5" src="../images/filtrodata.png" alt="filtroData">
                            Date
                        </bottom>
                        ...
                        <bottom class="flex flex-col items-center p-2 m-2 bg-lavender-500 rounded-lg hover:bg-ylblue-500 hover:text-white">
                            <img class="w-5" src="../images/filtrocategoria.png" alt="filtroCategoria"> 
                            Category
                        </bottom>
                    </div>
                </form>
