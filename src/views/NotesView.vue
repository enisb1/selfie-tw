<template>
                ...
                <form action="#">
                    ...
                    <div class="flex justify-center mx-12 p-4">
                        <button id="SaveButton"
                            class="px-4 py-1 shadow-xl hover:bg-third hover:text-white font-semibold">Save</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <!--Tasks-->
    <div class="grid grid-cols-1 mx-10 pt-10 pb-24 gap-8 lg:grid-cols-3 lg:py-40">
        <div v-show="notesVisible"
            class="h-32 rounded-r-xl rounded-bl-xl bg-white border-4 border-third shadow-2xl overflow-hidden">
            <h5 class="p-1 h-1/4 m-1 bg-fourth font-medium flex items-center text-third">NotaUnoooooooo</h5>
            <p class="px-2 text-xs">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia reprehenderit
                accusantium
